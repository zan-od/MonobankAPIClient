package zan.api.monobank.connector;

import zan.api.monobank.ApplicationConfig;
...
public class HttpApiConnector {
    ...
    public HttpApiConnector(ApplicationConfig applicationConfig, String token) throws IOException {
